...
**Agreement Reference:** ICT-A00456-529900FA-2024
...
Eurocastle Capital Management S.à r.l.
2, Boulevard Royal, L-2953 Luxembourg
CSSF Registration: A00456
LEI: 529900ABCDEF123GHI45
Entity Type: Alternative Investment Fund Manager
...
LEI: 529900FAKEAWS1234567
Provider Type: Hyperscale Cloud Provider
...
**Service Name:** Cloud Infrastructure as a Service (IaaS)

**Description:** Provision of virtualised compute, storage, and networking resources hosted in provider-operated data centres, including automated scaling, load balancing, and infrastructure monitoring.

1.2. The service supports a **critical or important function** of the Client, namely: *Trade execution and settlement processing*.

1.3. The ESA service type classification for this arrangement is: `ICT-SS-001`.

1.4. **Annual Cost:** EUR 520,000 (exclusive of VAT), payable in quarterly instalments.

## Article 2 — Subcontracting

2.1. The Provider may subcontract parts of the service to third parties as needed for service delivery.
...
|---|---|---|
| Primary processing | Germany (DE) | EU |
| Disaster recovery / backup | France (FR) | EU |
...
**For the Client — Eurocastle Capital Management S.à r.l.**

Name: _________________________
Title: Chief Operating Officer
Date: 2024-03-01

**For the Provider — Amazon Web Services EMEA SARL**
